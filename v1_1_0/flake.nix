{
  ...
  inputs.src-nimtetris-v1_1_0.flake = false;
  inputs.src-nimtetris-v1_1_0.ref   = "refs/tags/v1.1.0";
  inputs.src-nimtetris-v1_1_0.owner = "jiro4989";
  inputs.src-nimtetris-v1_1_0.repo  = "nimtetris";
  inputs.src-nimtetris-v1_1_0.dir   = "";
  inputs.src-nimtetris-v1_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimtetris-v1_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimtetris-v1_1_0";
